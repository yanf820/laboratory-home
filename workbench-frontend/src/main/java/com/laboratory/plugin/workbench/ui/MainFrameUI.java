package com.laboratory.plugin.workbench.ui;

import com.laboratory.plugin.workbench.domain.Resource;
import com.laboratory.plugin.workbench.domain.User;
import com.laboratory.plugin.workbench.util.SystemInitialization;
import com.laboratory.plugin.workbench.view.provider.ComponentViewProvider;
import com.laboratory.plugin.workbench.domain.Role;
import com.laboratory.plugin.workbench.view.menu.MenuBars;
